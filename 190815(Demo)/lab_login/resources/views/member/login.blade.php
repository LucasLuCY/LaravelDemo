...
<form id="form1" name="form1" method="post" action="/member/login">
  ...
  <table width="300" border="0" align="center" cellpadding="5" cellspacing="0" bgcolor="#F2F2F2">
    ...
    <td valign="baseline">
        <input type="text" name="txtUserName" id="txtUserName" value="{{ $request->txtUserName }}">
    </td>
    </tr>
    <tr>
        <td width="80" align="center" valign="baseline">密碼</td>
        <td valign="baseline">
            <input type="password" name="txtPassword" id="txtPassword" value="{{ $request->txtPassword }}">
        </td>
    </tr>
    <tr>
      ...
      <a href="/">
        <input type="button" name="btnHome" id="btnHome" value="回首頁" />
      </a>
